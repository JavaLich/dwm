...
static const char col_cyan[] = "#ffc86a";
static const char col_green[] = "#2BE491";
static const unsigned int baralpha = 0x00;
static const unsigned int borderalpha = OPAQUE;
static const char *colors[][3] = {
    /*               fg         bg         border   */
    [SchemeNorm] = {col_gray3, /* col_gray1 */ "#000000", col_gray2},
    [SchemeSel] = {col_cyan, /* col_gray1 */ "#000000", col_cyan},
};
...
static const char *dmenucmd[] = {"dmenu_run", "-i", "-c",     "-l",
                                 "10",        "-m", dmenumon, NULL};
